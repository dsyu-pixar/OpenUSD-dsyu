...
`Ambient` is non-spatial and sounds the same regardles of the listener's 
position.
...
Valid values are: 
 ...
 - `nonSpatial`: Does not consider the prims location, intended to be used 
 for ambient sounds.
